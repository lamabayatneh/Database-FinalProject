...
public class AdminBooksView extends BorderPane {
	...
	public AdminBooksView(Stage stage) {
		...
		idCol.setCellValueFactory(
				d -> new javafx.beans.property.SimpleIntegerProperty(d.getValue().getBookID()).asObject());
		...
		priceCol.setCellValueFactory(
				d -> new javafx.beans.property.SimpleDoubleProperty(d.getValue().getPrice()).asObject());

		TableColumn<Book, Integer> qtyCol = new TableColumn<>("Qty");
		qtyCol.setCellValueFactory(
				d -> new javafx.beans.property.SimpleIntegerProperty(d.getValue().getQuantity()).asObject());
