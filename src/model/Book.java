...
public class Book {
    ...
    public Book(int bookID, String title, String author,
                double price, int quantity, LocalDate addedDate,
    ...
    public Book(int bookID, String title, String author, double price, int quantity, LocalDate addedDate, String imagePath) {
        this.bookID = bookID;
        this.title = title;
        this.author = author;
        this.price = price;
